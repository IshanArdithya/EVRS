...
export default function HospitalProfilePage() {
  ...
  const handlePhoneChangeRequest = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await api.post("/hospital/profile/phone/request", {
  ...
  const handlePhoneVerification = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await api.post("/hospital/profile/phone/verify", {
        code: phonePin,
      });
  ...
  const handlePasswordChange = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await api.put("/hospital/profile/password", {
        currentPassword,
        newPassword,
      });
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage your hospital information and security settings
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your hospital profile information. Most fields cannot be changed
